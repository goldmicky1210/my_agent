...
def build_system_prompt() -> str:
    return (
        ...
        "done: only when task is fully completed (the target event has been triggered).\n"
        ...
        "IMPORTANT: After a successful action (button click, form submit, navigation), return done=true "
        "only if you are confident the required event has been triggered. Otherwise continue.\n"
